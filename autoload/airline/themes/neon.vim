...
" Filename: autoload/airline/themes/neon.vim
" Author: Sainnhepark
...
if &background ==# 'dark'
    ...
    let s:background_alt = [ '#2b2d3c', 236 ]
    ...
    let s:background_alt = [ '#eeeefa', 255 ]
    let s:background_grey = [ '#e4e3f3', 253 ]
...
let g:airline#themes#neon#palette.accents = {
...
let g:airline#themes#neon#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
...
let g:airline#themes#neon#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
...
let g:airline#themes#neon#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
...
let g:airline#themes#neon#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
...
let g:airline#themes#neon#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
