...
if get(g:, 'edge_style', 'default') ==# 'default'
    if &background ==# 'dark'
        ...
        let s:purple_sel = [ '#d696e9', 176 ]
        let s:green_sel = [ '#a0c781', 107 ]
        let s:blue_sel = [ '#77bceb', 110 ]
        let s:red_fg = [ '#f27a7a', 203 ]
        let s:purple_fg = [ '#d696e9', 176 ]
        let s:green_fg = [ '#a0c781', 107 ]
        let s:blue_fg = [ '#77bceb', 110 ]
    else
