...
" Last Updated: Tue 30 Jul 2019 04:38:02 PM CST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if has('nvim')
      ...
      let g:terminal_color_12 = '#96b5e7'
      let g:terminal_color_13 = '#d390e7'
      let g:terminal_color_14 = '#78bfa1'
    ...
    hi Cyan guifg=#78bfa1 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Blue guifg=#96b5e7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi ModeMsg guifg=#96b5e7 guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    hi PmenuSel guifg=#262729 guibg=#96b5e7 guisp=NONE gui=NONE cterm=NONE
    ...
    hi SpellLocal guifg=#96b5e7 guibg=NONE guisp=#96b5e7 gui=NONE cterm=NONE
    ...
    hi Identifier guifg=#78bfa1 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Constant guifg=#78bfa1 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Function guifg=#96b5e7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Operator guifg=#96b5e7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Title guifg=#96b5e7 guibg=NONE guisp=NONE gui=bold cterm=bold
    hi Statement guifg=#96b5e7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi SpecialKey guifg=#96b5e7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi Define guifg=#d390e7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi StorageClass guifg=#d390e7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Label guifg=#d390e7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi Statement guifg=#6587bf guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi Define guifg=#b870ce guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi StorageClass guifg=#b870ce guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Label guifg=#b870ce guibg=NONE guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi Label ctermfg=134 ctermbg=NONE cterm=NONE
...
" Color: cyan          #78bfa1           ~                 Cyan
" Color: blue          #96b5e7           ~                 Blue
