...
" Last Updated: Sat 14 Dec 2019 09:03:44 PM CST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, 'edge_transparent_background', 0)
      ...
      hi GitGutterAdd guifg=#a2bc81 guibg=#2c2d33 guisp=NONE gui=NONE cterm=NONE
    ...
    hi deniteInput guifg=#a2bc81 guibg=#2c2d33 guisp=NONE gui=bold cterm=bold
  ...
  " Light background
  let g:terminal_ansi_colors = ['#52565f', '#d15f5f', '#688d31', '#c18401',
        \ '#5079be', '#b05ccc', '#338f87', '#949ba5', '#52565f', '#d15f5f',
        \ '#688d31', '#c18401', '#5079be', '#b05ccc', '#338f87', '#949ba5']
  if has('nvim')
...
" Color: green         #a2bc81           ~                 Green          # 67.417
...
" Color: green         #688d31           ~                 Green          # 48.827
