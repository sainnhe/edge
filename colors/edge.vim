...
" Last Updated: Fri 13 Dec 2019 03:29:14 PM CST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, 'edge_popup_menu_selection_background', 'blue') ==# 'blue'
      hi PmenuSel guifg=#34363f guibg=#77b3e4 guisp=NONE gui=NONE cterm=NONE
      hi WildMenu guifg=#2c2d33 guibg=#77b3e4 guisp=NONE gui=NONE cterm=NONE
    elseif get(g:, 'edge_popup_menu_selection_background', 'green') ==# 'green'
      hi PmenuSel guifg=#34363f guibg=#a1ba80 guisp=NONE gui=NONE cterm=NONE
      hi WildMenu guifg=#2c2d33 guibg=#a1ba80 guisp=NONE gui=NONE cterm=NONE
    elseif get(g:, 'edge_popup_menu_selection_background', 'purple') ==# 'purple'
      hi PmenuSel guifg=#34363f guibg=#d898eb guisp=NONE gui=NONE cterm=NONE
  ...
  if get(g:, 'edge_popup_menu_selection_background', 'blue') ==# 'blue'
    hi PmenuSel guifg=#e8ebf0 guibg=#5079be guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#eef1f4 guibg=#5079be guisp=NONE gui=NONE cterm=NONE
  elseif get(g:, 'edge_popup_menu_selection_background', 'green') ==# 'green'
    hi PmenuSel guifg=#e8ebf0 guibg=#6c9334 guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#eef1f4 guibg=#6c9334 guisp=NONE gui=NONE cterm=NONE
  elseif get(g:, 'edge_popup_menu_selection_background', 'purple') ==# 'purple'
    hi PmenuSel guifg=#e8ebf0 guibg=#b05ccc guisp=NONE gui=NONE cterm=NONE
    hi WildMenu guifg=#eef1f4 guibg=#b05ccc guisp=NONE gui=NONE cterm=NONE
  endif
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, 'edge_popup_menu_selection_background', 'blue') ==# 'blue'
      hi PmenuSel ctermfg=237 ctermbg=110 cterm=NONE
      hi WildMenu ctermfg=236 ctermbg=110 cterm=NONE
    elseif get(g:, 'edge_popup_menu_selection_background', 'green') ==# 'green'
      hi PmenuSel ctermfg=237 ctermbg=107 cterm=NONE
      hi WildMenu ctermfg=236 ctermbg=107 cterm=NONE
    elseif get(g:, 'edge_popup_menu_selection_background', 'purple') ==# 'purple'
      hi PmenuSel ctermfg=237 ctermbg=176 cterm=NONE
  ...
  elseif get(g:, 'edge_popup_menu_selection_background', 'green') ==# 'green'
    hi PmenuSel ctermfg=255 ctermbg=64 cterm=NONE
    hi WildMenu ctermfg=255 ctermbg=64 cterm=NONE
  elseif get(g:, 'edge_popup_menu_selection_background', 'purple') ==# 'purple'
    hi PmenuSel ctermfg=255 ctermbg=134 cterm=NONE
    hi WildMenu ctermfg=255 ctermbg=134 cterm=NONE
  endif
...
if s:t_Co >= 8
  if &background ==# 'dark'
    ...
    if get(g:, 'edge_popup_menu_selection_background', 'blue') ==# 'blue'
      ...
      hi WildMenu ctermfg=LightGrey ctermbg=Blue cterm=NONE
    elseif get(g:, 'edge_popup_menu_selection_background', 'green') ==# 'green'
      hi PmenuSel ctermfg=LightGrey ctermbg=Green cterm=NONE
      hi WildMenu ctermfg=LightGrey ctermbg=Green cterm=NONE
    elseif get(g:, 'edge_popup_menu_selection_background', 'purple') ==# 'purple'
      hi PmenuSel ctermfg=LightGrey ctermbg=Magenta cterm=NONE
      hi WildMenu ctermfg=LightGrey ctermbg=Magenta cterm=NONE
    endif
