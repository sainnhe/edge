...
" Last Updated: Tue 30 Jul 2019 05:35:46 PM CST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['fg', '#e77171', '#a1bf78', '#ddb66c',
          \ '#7dbaec', '#d390e7', '#3dc3b9', '#88909f', 'fg', '#e77171',
          \ '#a1bf78', '#ddb66c', '#7dbaec', '#d390e7', '#3dc3b9', '#88909f']
    if has('nvim')
      ...
      let g:terminal_color_14 = '#3dc3b9'
    ...
    hi Cyan guifg=#3dc3b9 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi Identifier guifg=#3dc3b9 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Constant guifg=#3dc3b9 guibg=NONE guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi Cyan ctermfg=44 ctermbg=NONE cterm=NONE
