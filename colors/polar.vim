...
" Last Updated: Sun 15 Dec 2019 09:57:56 PM CST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if has('nvim')
      ...
      let g:terminal_color_12 = '#95b8f2'
    ...
    hi Blue guifg=#95b8f2 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi MoreMsg guifg=#95b8f2 guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    if get(g:, 'edge_popup_menu_selection_background', 'blue') ==# 'blue'
      hi PmenuSel guifg=#252931 guibg=#95b8f2 guisp=NONE gui=NONE cterm=NONE
      hi WildMenu guifg=#252931 guibg=#95b8f2 guisp=NONE gui=NONE cterm=NONE
    ...
    hi SpellLocal guifg=#95b8f2 guibg=NONE guisp=#95b8f2 gui=NONE cterm=NONE
    ...
    hi QuickFixLine guifg=#95b8f2 guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    ...
    hi Operator guifg=#95b8f2 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi SpecialKey guifg=#95b8f2 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    if get(g:, 'edge_transparent_background', 0)
      ...
      hi GitGutterChange guifg=#95b8f2 guibg=NONE guisp=NONE gui=NONE cterm=NONE
      ...
      hi GitGutterChange guifg=#95b8f2 guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    ...
    if get(g:, 'edge_transparent_background', 0)
      hi SignatureMarkText guifg=#95b8f2 guibg=NONE guisp=NONE gui=NONE cterm=NONE
      hi SignatureMarkerText guifg=#d898eb guibg=NONE guisp=NONE gui=NONE cterm=NONE
    else
      hi SignatureMarkText guifg=#95b8f2 guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    ...
    hi CtrlPMode1 guifg=#95b8f2 guibg=#2e3440 guisp=NONE gui=bold cterm=bold
    hi CtrlPMode2 guifg=#2e3440 guibg=#95b8f2 guisp=NONE gui=bold cterm=bold
    ...
    hi Lf_hl_match2 guifg=#95b8f2 guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    hi ALEInfo guifg=NONE guibg=NONE guisp=#95b8f2 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
    if get(g:, 'edge_transparent_background', 0)
      ...
      hi ALEInfoSign guifg=#95b8f2 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    else
      ...
      hi ALEInfoSign guifg=#95b8f2 guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    endif
    ...
    hi QuickScopeSecondary guifg=#95b8f2 guibg=NONE guisp=NONE gui=underline cterm=underline
    ...
    hi markdownH6 guifg=#95b8f2 guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    hi htmlH6 guifg=#95b8f2 guibg=NONE guisp=NONE gui=bold cterm=bold
...
" Color: background_blue_sel #95b8f2     ~                 LightBlue
