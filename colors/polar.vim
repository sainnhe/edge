...
" Last Updated: Sun 15 Dec 2019 05:55:26 PM CST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['#bcc4d1', '#ef7f7f', '#a2bc81', '#d2b57b',
          \ '#77b3e4', '#d898eb', '#72bab3', '#88909f', '#bcc4d1', '#ef7f7f',
          \ '#a2bc81', '#d2b57b', '#77b3e4', '#d898eb', '#72bab3', '#88909f']
    if has('nvim')
      let g:terminal_color_0 = '#bcc4d1'
      let g:terminal_color_1 = '#ef7f7f'
      let g:terminal_color_2 = '#a2bc81'
      ...
      let g:terminal_color_10 = '#a2bc81'
    ...
    hi Green guifg=#a2bc81 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    if get(g:, 'edge_transparent_background', 0) && !has('gui_running')
      ...
      hi Normal guifg=#bcc4d1 guibg=#252932 guisp=NONE gui=NONE cterm=NONE
      hi Terminal guifg=#bcc4d1 guibg=#252932 guisp=NONE gui=NONE cterm=NONE
      hi EndOfBuffer guifg=#252932 guibg=#252932 guisp=NONE gui=NONE cterm=NONE
      hi FoldColumn guifg=#88909f guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
      hi Folded guifg=#88909f guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
      hi SignColumn guifg=NONE guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
    endif
    hi ColorColumn guifg=NONE guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
    ...
    hi CursorColumn guifg=NONE guibg=#2a303b guisp=NONE gui=NONE cterm=NONE
    hi CursorLine guifg=NONE guibg=#2a303b guisp=NONE gui=NONE cterm=NONE
    ...
    if &rnu == 1 && &cul == 0
      ...
      hi CursorLineNr guifg=#bcc4d1 guibg=#2a303b guisp=NONE gui=NONE cterm=NONE
    endif
    ...
    hi Directory guifg=#a2bc81 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi Search guifg=NONE guibg=#37404f guisp=NONE gui=NONE cterm=NONE
    hi MatchParen guifg=NONE guibg=#3c4656 guisp=NONE gui=NONE cterm=NONE
    hi NonText guifg=#88909f guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Pmenu guifg=#bcc4d1 guibg=#323947 guisp=NONE gui=NONE cterm=NONE
    hi PmenuSbar guifg=NONE guibg=#323947 guisp=NONE gui=NONE cterm=NONE
    if get(g:, 'edge_popup_menu_selection_background', 'blue') ==# 'blue'
      hi PmenuSel guifg=#252932 guibg=#72b1e5 guisp=NONE gui=NONE cterm=NONE
      hi WildMenu guifg=#252932 guibg=#72b1e5 guisp=NONE gui=NONE cterm=NONE
    elseif get(g:, 'edge_popup_menu_selection_background', 'green') ==# 'green'
      hi PmenuSel guifg=#252932 guibg=#98be72 guisp=NONE gui=NONE cterm=NONE
      hi WildMenu guifg=#252932 guibg=#98be72 guisp=NONE gui=NONE cterm=NONE
    elseif get(g:, 'edge_popup_menu_selection_background', 'purple') ==# 'purple'
      hi PmenuSel guifg=#252932 guibg=#d898eb guisp=NONE gui=NONE cterm=NONE
      hi WildMenu guifg=#252932 guibg=#d898eb guisp=NONE gui=NONE cterm=NONE
    endif
    hi PmenuThumb guifg=NONE guibg=#7c8898 guisp=NONE gui=NONE cterm=NONE
    ...
    hi StatusLine guifg=#bcc4d1 guibg=#3c4656 guisp=NONE gui=NONE cterm=NONE
    hi StatusLineTerm guifg=#bcc4d1 guibg=#3c4656 guisp=NONE gui=NONE cterm=NONE
    hi StatusLineNC guifg=#88909f guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
    hi StatusLineTermNC guifg=#88909f guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
    hi TabLine guifg=#bcc4d1 guibg=#3c4656 guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#88909f guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#252932 guibg=#d898eb guisp=NONE gui=NONE cterm=NONE
    hi VertSplit guifg=#3c4656 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Visual guifg=NONE guibg=#37404f guisp=NONE gui=NONE cterm=NONE
    hi VisualNOS guifg=NONE guibg=#37404f guisp=NONE gui=italic cterm=italic
    ...
    hi ToolbarButton guifg=#bcc4d1 guibg=#252932 guisp=NONE gui=bold cterm=bold
    hi QuickFixLine guifg=#77b3e4 guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
    ...
    hi Boolean guifg=#a2bc81 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi String guifg=#a2bc81 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Character guifg=#a2bc81 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Number guifg=#a2bc81 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Float guifg=#a2bc81 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi plugNumber guifg=#a2bc81 guibg=NONE guisp=NONE gui=bold cterm=bold
    if get(g:, 'edge_transparent_background', 0)
      hi GitGutterAdd guifg=#a2bc81 guibg=NONE guisp=NONE gui=NONE cterm=NONE
      ...
      hi GitGutterAdd guifg=#a2bc81 guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
      hi GitGutterChange guifg=#77b3e4 guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
      hi GitGutterDelete guifg=#ef7f7f guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
      hi GitGutterChangeDelete guifg=#d898eb guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
    endif
    if get(g:, 'edge_transparent_background', 0)
      ...
      hi SignatureMarkText guifg=#77b3e4 guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
      hi SignatureMarkerText guifg=#d898eb guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
    endif
    hi CtrlPMatch guifg=#a2bc81 guibg=NONE guisp=NONE gui=bold cterm=bold
    hi CtrlPPrtBase guifg=#7c8898 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi CtrlPLinePre guifg=#7c8898 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi CtrlPMode1 guifg=#77b3e4 guibg=#2e343f guisp=NONE gui=bold cterm=bold
    hi CtrlPMode2 guifg=#2e343f guibg=#77b3e4 guisp=NONE gui=bold cterm=bold
    hi CtrlPStats guifg=#88909f guibg=#2e343f guisp=NONE gui=bold cterm=bold
    hi Lf_hl_match guifg=#a2bc81 guibg=NONE guisp=NONE gui=bold cterm=bold
    hi Lf_hl_match0 guifg=#a2bc81 guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    hi deniteMatchedChar guifg=#a2bc81 guibg=NONE guisp=NONE gui=bold cterm=bold
    hi deniteMatchedRange guifg=#a2bc81 guibg=NONE guisp=NONE gui=bold,underline cterm=bold,underline
    hi deniteInput guifg=#a2bc81 guibg=#2e343f guisp=NONE gui=bold cterm=bold
    hi deniteStatusLineNumber guifg=#d898eb guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
    hi deniteStatusLinePath guifg=#bcc4d1 guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
    ...
    if get(g:, 'edge_transparent_background', 0)
      ...
      hi ALEErrorSign guifg=#ef7f7f guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
      hi ALEWarningSign guifg=#d2b57b guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
      hi ALEInfoSign guifg=#77b3e4 guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
    endif
    ...
    elseif get(g:, 'edge_current_word', get(g:, 'edge_transparent_background', 0) == 0 ? 'grey background' : 'bold') ==# 'grey background'
      hi CocHighlightText guifg=NONE guibg=#323947 guisp=NONE gui=NONE cterm=NONE
    endif
    ...
    if get(g:, 'edge_transparent_background', 0)
      ...
      hi CocHintSign guifg=#72bab3 guibg=#2e343f guisp=NONE gui=NONE cterm=NONE
    endif
    ...
    hi QuickScopePrimary guifg=#a2bc81 guibg=NONE guisp=NONE gui=underline cterm=underline
    ...
    hi markdownH4 guifg=#a2bc81 guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    hi markdownUrl guifg=#a2bc81 guibg=NONE guisp=NONE gui=underline cterm=underline
    ...
    hi mkdURL guifg=#a2bc81 guibg=NONE guisp=NONE gui=underline cterm=underline
    hi mkdItalic guifg=#88909f guibg=NONE guisp=NONE gui=italic cterm=italic
    hi rstStandaloneHyperlink guifg=#a2bc81 guibg=NONE guisp=NONE gui=underline cterm=underline
    ...
    hi htmlH4 guifg=#a2bc81 guibg=NONE guisp=NONE gui=bold cterm=bold
  ...
  if get(g:, 'edge_transparent_background', 0) && !has('gui_running')
    ...
    hi FoldColumn guifg=#949ba5 guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
    hi Folded guifg=#949ba5 guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
    hi SignColumn guifg=NONE guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
  endif
  hi ColorColumn guifg=NONE guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
  hi Conceal guifg=#949ba5 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Cursor guifg=NONE guibg=NONE guisp=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi lCursor guifg=NONE guibg=NONE guisp=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi CursorColumn guifg=NONE guibg=#f1f5f7 guisp=NONE gui=NONE cterm=NONE
  hi CursorLine guifg=NONE guibg=#f1f5f7 guisp=NONE gui=NONE cterm=NONE
  ...
  if &rnu == 1 && &cul == 0
    ...
    hi CursorLineNr guifg=#4b505b guibg=#f1f5f7 guisp=NONE gui=NONE cterm=NONE
  endif
  ...
  hi Search guifg=NONE guibg=#e2e9f0 guisp=NONE gui=NONE cterm=NONE
  hi MatchParen guifg=NONE guibg=#dde5ec guisp=NONE gui=NONE cterm=NONE
  hi NonText guifg=#949ba5 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Pmenu guifg=#4b505b guibg=#e7ecf3 guisp=NONE gui=NONE cterm=NONE
  hi PmenuSbar guifg=NONE guibg=#e7ecf3 guisp=NONE gui=NONE cterm=NONE
  if get(g:, 'edge_popup_menu_selection_background', 'blue') ==# 'blue'
  ...
  hi PmenuThumb guifg=NONE guibg=#bbc8d6 guisp=NONE gui=NONE cterm=NONE
  ...
  hi StatusLine guifg=#4b505b guibg=#dde5ec guisp=NONE gui=NONE cterm=NONE
  hi StatusLineTerm guifg=#4b505b guibg=#dde5ec guisp=NONE gui=NONE cterm=NONE
  hi StatusLineNC guifg=#949ba5 guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
  hi StatusLineTermNC guifg=#949ba5 guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
  hi TabLine guifg=#4b505b guibg=#dde5ec guisp=NONE gui=NONE cterm=NONE
  hi TabLineFill guifg=#949ba5 guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#fafafa guibg=#bf75d6 guisp=NONE gui=NONE cterm=NONE
  hi VertSplit guifg=#dde5ec guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Visual guifg=NONE guibg=#e2e9f0 guisp=NONE gui=NONE cterm=NONE
  hi VisualNOS guifg=NONE guibg=#e2e9f0 guisp=NONE gui=italic cterm=italic
  ...
  hi QuickFixLine guifg=#5079be guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
  ...
  if get(g:, 'edge_transparent_background', 0)
    ...
    hi GitGutterAdd guifg=#688d31 guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
    hi GitGutterChange guifg=#5079be guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
    hi GitGutterDelete guifg=#d15f5f guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
    hi GitGutterChangeDelete guifg=#b05ccc guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
  endif
  if get(g:, 'edge_transparent_background', 0)
    ...
    hi SignatureMarkText guifg=#5079be guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
    hi SignatureMarkerText guifg=#b05ccc guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
  endif
  hi CtrlPMatch guifg=#688d31 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi CtrlPPrtBase guifg=#bbc8d6 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi CtrlPLinePre guifg=#bbc8d6 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi CtrlPMode1 guifg=#5079be guibg=#edf2f7 guisp=NONE gui=bold cterm=bold
  hi CtrlPMode2 guifg=#edf2f7 guibg=#5079be guisp=NONE gui=bold cterm=bold
  hi CtrlPStats guifg=#949ba5 guibg=#edf2f7 guisp=NONE gui=bold cterm=bold
  ...
  hi deniteInput guifg=#688d31 guibg=#edf2f7 guisp=NONE gui=bold cterm=bold
  hi deniteStatusLineNumber guifg=#b05ccc guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
  hi deniteStatusLinePath guifg=#4b505b guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
  ...
  if get(g:, 'edge_transparent_background', 0)
    ...
    hi ALEErrorSign guifg=#d15f5f guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
    hi ALEWarningSign guifg=#c18401 guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
    hi ALEInfoSign guifg=#5079be guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
  endif
  if get(g:, 'edge_current_word', get(g:, 'edge_transparent_background', 0) == 0 ? 'grey background' : 'bold') ==# 'bold'
    hi CocHighlightText guifg=NONE guibg=NONE guisp=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold
  elseif get(g:, 'edge_current_word', get(g:, 'edge_transparent_background', 0) == 0 ? 'grey background' : 'bold') ==# 'underline'
  ...
  elseif get(g:, 'edge_current_word', get(g:, 'edge_transparent_background', 0) == 0 ? 'grey background' : 'bold') ==# 'grey background'
    hi CocHighlightText guifg=NONE guibg=#e7ecf3 guisp=NONE gui=NONE cterm=NONE
  endif
  hi CocHoverRange guifg=NONE guibg=NONE guisp=NONE gui=bold,underline ctermfg=NONE ctermbg=NONE cterm=bold,underline
  if get(g:, 'edge_transparent_background', 0)
    hi CocHintSign guifg=#358c84 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
    hi CocHintSign guifg=#358c84 guibg=#edf2f7 guisp=NONE gui=NONE cterm=NONE
  endif
  hi MatchParenCur guifg=NONE guibg=NONE guisp=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold
  hi MatchWord guifg=NONE guibg=NONE guisp=NONE gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
  hi MatchWordCur guifg=NONE guibg=NONE guisp=NONE gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    elseif get(g:, 'edge_popup_menu_selection_background', 'green') ==# 'green'
      hi PmenuSel ctermfg=235 ctermbg=107 cterm=NONE
    ...
    hi StatusLineTerm ctermfg=251 ctermbg=238 cterm=NONE
    ...
    hi CtrlPPrtBase ctermfg=102 ctermbg=NONE cterm=NONE
    hi CtrlPLinePre ctermfg=102 ctermbg=NONE cterm=NONE
...
" Background: dark
" Color: background    #252932           ~                 Black
" Color: foreground    #bcc4d1           ~                 White          # 76.506
" Color: red           #ef7f7f           ~                 Red            # 62.934
" Color: yellow        #d2b57b           ~                 Yellow         # 71.787
" Color: green         #a2bc81           ~                 Green          # 68.039
" Color: cyan          #72bab3           ~                 Cyan           # 64.188
" Color: blue          #77b3e4           ~                 Blue           # 65.353
" Color: purple        #d898eb           ~                 Magenta        # 70.822
" Color: grey          #88909f           ~                 Grey
" Color: background_line #2a303b         ~                 LightGrey
" Color: background_col #2e343f          ~                 LightGrey
" Color: background_pmenu #323947        ~                 LightGrey
" Color: background_sign #3c4656         ~                 LightGrey
" Color: background_visual #37404f       ~                 LightGrey
" Color: background_grey #7c8898         ~                 LightGrey
...
" Color: background_line #f1f5f7         ~                 LightGrey
" Color: background_col #edf2f7          ~                 LightGrey
" Color: background_pmenu #e7ecf3        ~                 LightGrey
" Color: background_sign #dde5ec         ~                 LightGrey
" Color: background_visual #e2e9f0       ~                 LightGrey
" Color: background_grey #bbc8d6         ~                 LightGrey
