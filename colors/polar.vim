...
" Last Updated: Mon 16 Dec 2019 07:45:21 AM CST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['#bcc4d1', '#ef7f7f', '#a3be8c', '#d2b57b',
          \ '#94b7f0', '#d898eb', '#7cbcbb', '#88909f', '#bcc4d1', '#ef7f7f',
          \ '#a3be8c', '#d2b57b', '#94b7f0', '#d898eb', '#7cbcbb', '#88909f']
    if has('nvim')
      let g:terminal_color_0 = '#bcc4d1'
      let g:terminal_color_1 = '#ef7f7f'
      let g:terminal_color_2 = '#a3be8c'
      let g:terminal_color_3 = '#d2b57b'
      let g:terminal_color_4 = '#94b7f0'
      let g:terminal_color_5 = '#d898eb'
      let g:terminal_color_6 = '#7cbcbb'
      ...
      let g:terminal_color_12 = '#94b7f0'
      let g:terminal_color_13 = '#d898eb'
      let g:terminal_color_14 = '#7cbcbb'
    ...
    hi Green guifg=#a3be8c guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Cyan guifg=#7cbcbb guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Blue guifg=#94b7f0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    if get(g:, 'edge_transparent_background', 0) && !has('gui_running')
      ...
      hi Normal guifg=#bcc4d1 guibg=#252931 guisp=NONE gui=NONE cterm=NONE
      hi Terminal guifg=#bcc4d1 guibg=#252931 guisp=NONE gui=NONE cterm=NONE
      hi EndOfBuffer guifg=#252931 guibg=#252931 guisp=NONE gui=NONE cterm=NONE
      hi FoldColumn guifg=#88909f guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
      hi Folded guifg=#88909f guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
      hi SignColumn guifg=NONE guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    endif
    hi ColorColumn guifg=NONE guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    ...
    hi CursorColumn guifg=NONE guibg=#2c313b guisp=NONE gui=NONE cterm=NONE
    hi CursorLine guifg=NONE guibg=#2c313b guisp=NONE gui=NONE cterm=NONE
    ...
    if &rnu == 1 && &cul == 0
      ...
      hi CursorLineNr guifg=#bcc4d1 guibg=#2c313b guisp=NONE gui=NONE cterm=NONE
    endif
    ...
    hi MoreMsg guifg=#94b7f0 guibg=NONE guisp=NONE gui=bold cterm=bold
    hi IncSearch guifg=NONE guibg=#573c3d guisp=NONE gui=bold,underline cterm=bold,underline
    hi Search guifg=NONE guibg=#3b4252 guisp=NONE gui=NONE cterm=NONE
    hi MatchParen guifg=NONE guibg=#434c5e guisp=NONE gui=NONE cterm=NONE
    hi NonText guifg=#88909f guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Pmenu guifg=#bcc4d1 guibg=#393f4e guisp=NONE gui=NONE cterm=NONE
    hi PmenuSbar guifg=NONE guibg=#393f4e guisp=NONE gui=NONE cterm=NONE
    if get(g:, 'edge_popup_menu_selection_background', 'blue') ==# 'blue'
      hi PmenuSel guifg=#252931 guibg=#94b7f0 guisp=NONE gui=NONE cterm=NONE
      hi WildMenu guifg=#252931 guibg=#94b7f0 guisp=NONE gui=NONE cterm=NONE
    elseif get(g:, 'edge_popup_menu_selection_background', 'green') ==# 'green'
      hi PmenuSel guifg=#252931 guibg=#a3be8c guisp=NONE gui=NONE cterm=NONE
      hi WildMenu guifg=#252931 guibg=#a3be8c guisp=NONE gui=NONE cterm=NONE
    elseif get(g:, 'edge_popup_menu_selection_background', 'purple') ==# 'purple'
      hi PmenuSel guifg=#252931 guibg=#d898eb guisp=NONE gui=NONE cterm=NONE
      hi WildMenu guifg=#252931 guibg=#d898eb guisp=NONE gui=NONE cterm=NONE
    endif
    ...
    hi SpellLocal guifg=#94b7f0 guibg=NONE guisp=#94b7f0 gui=NONE cterm=NONE
    hi SpellRare guifg=#d898eb guibg=NONE guisp=#d898eb gui=NONE cterm=NONE
    hi StatusLine guifg=#bcc4d1 guibg=#434c5e guisp=NONE gui=NONE cterm=NONE
    hi StatusLineTerm guifg=#bcc4d1 guibg=#434c5e guisp=NONE gui=NONE cterm=NONE
    hi StatusLineNC guifg=#88909f guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    hi StatusLineTermNC guifg=#88909f guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    hi TabLine guifg=#bcc4d1 guibg=#434c5e guisp=NONE gui=NONE cterm=NONE
    hi TabLineFill guifg=#88909f guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    hi TabLineSel guifg=#252931 guibg=#d898eb guisp=NONE gui=NONE cterm=NONE
    hi VertSplit guifg=#434c5e guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Visual guifg=NONE guibg=#3b4252 guisp=NONE gui=NONE cterm=NONE
    hi VisualNOS guifg=NONE guibg=#3b4252 guisp=NONE gui=italic cterm=italic
    ...
    hi ToolbarButton guifg=#bcc4d1 guibg=#252931 guisp=NONE gui=bold cterm=bold
    hi QuickFixLine guifg=#94b7f0 guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    ...
    hi Boolean guifg=#a3be8c guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi Number guifg=#a3be8c guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Float guifg=#a3be8c guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Identifier guifg=#7cbcbb guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Constant guifg=#7cbcbb guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Function guifg=#94b7f0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Operator guifg=#94b7f0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi SpecialKey guifg=#94b7f0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi plugNumber guifg=#a3be8c guibg=NONE guisp=NONE gui=bold cterm=bold
    if get(g:, 'edge_transparent_background', 0)
      hi GitGutterAdd guifg=#a3be8c guibg=NONE guisp=NONE gui=NONE cterm=NONE
      hi GitGutterChange guifg=#94b7f0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
      ...
      hi GitGutterAdd guifg=#a3be8c guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
      hi GitGutterChange guifg=#94b7f0 guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
      hi GitGutterDelete guifg=#ef7f7f guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
      hi GitGutterChangeDelete guifg=#d898eb guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    endif
    if get(g:, 'edge_transparent_background', 0)
      hi SignatureMarkText guifg=#94b7f0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
      hi SignatureMarkerText guifg=#d898eb guibg=NONE guisp=NONE gui=NONE cterm=NONE
    else
      hi SignatureMarkText guifg=#94b7f0 guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
      hi SignatureMarkerText guifg=#d898eb guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    endif
    hi CtrlPMatch guifg=#a3be8c guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    hi CtrlPMode1 guifg=#94b7f0 guibg=#2e3440 guisp=NONE gui=bold cterm=bold
    hi CtrlPMode2 guifg=#2e3440 guibg=#94b7f0 guisp=NONE gui=bold cterm=bold
    hi CtrlPStats guifg=#88909f guibg=#2e3440 guisp=NONE gui=bold cterm=bold
    hi Lf_hl_match guifg=#a3be8c guibg=NONE guisp=NONE gui=bold cterm=bold
    hi Lf_hl_match0 guifg=#a3be8c guibg=NONE guisp=NONE gui=bold cterm=bold
    hi Lf_hl_match1 guifg=#7cbcbb guibg=NONE guisp=NONE gui=bold cterm=bold
    hi Lf_hl_match2 guifg=#94b7f0 guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    hi deniteMatchedChar guifg=#a3be8c guibg=NONE guisp=NONE gui=bold cterm=bold
    hi deniteMatchedRange guifg=#a3be8c guibg=NONE guisp=NONE gui=bold,underline cterm=bold,underline
    hi deniteInput guifg=#a3be8c guibg=#2e3440 guisp=NONE gui=bold cterm=bold
    hi deniteStatusLineNumber guifg=#d898eb guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    hi deniteStatusLinePath guifg=#bcc4d1 guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    ...
    hi ALEInfo guifg=NONE guibg=NONE guisp=#94b7f0 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=undercurl
    if get(g:, 'edge_transparent_background', 0)
      ...
      hi ALEInfoSign guifg=#94b7f0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    else
      hi ALEErrorSign guifg=#ef7f7f guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
      hi ALEWarningSign guifg=#d2b57b guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
      hi ALEInfoSign guifg=#94b7f0 guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    endif
    ...
    elseif get(g:, 'edge_current_word', get(g:, 'edge_transparent_background', 0) == 0 ? 'grey background' : 'bold') ==# 'grey background'
      hi CocHighlightText guifg=NONE guibg=#393f4e guisp=NONE gui=NONE cterm=NONE
    endif
    hi CocHoverRange guifg=NONE guibg=NONE guisp=NONE gui=bold,underline ctermfg=NONE ctermbg=NONE cterm=bold,underline
    if get(g:, 'edge_transparent_background', 0)
      hi CocHintSign guifg=#7cbcbb guibg=NONE guisp=NONE gui=NONE cterm=NONE
    else
      hi CocHintSign guifg=#7cbcbb guibg=#2e3440 guisp=NONE gui=NONE cterm=NONE
    endif
    ...
    hi QuickScopePrimary guifg=#a3be8c guibg=NONE guisp=NONE gui=underline cterm=underline
    hi QuickScopeSecondary guifg=#94b7f0 guibg=NONE guisp=NONE gui=underline cterm=underline
    ...
    hi markdownH4 guifg=#a3be8c guibg=NONE guisp=NONE gui=bold cterm=bold
    hi markdownH5 guifg=#7cbcbb guibg=NONE guisp=NONE gui=bold cterm=bold
    hi markdownH6 guifg=#94b7f0 guibg=NONE guisp=NONE gui=bold cterm=bold
    hi markdownUrl guifg=#a3be8c guibg=NONE guisp=NONE gui=underline cterm=underline
    ...
    hi mkdURL guifg=#a3be8c guibg=NONE guisp=NONE gui=underline cterm=underline
    hi mkdItalic guifg=#88909f guibg=NONE guisp=NONE gui=italic cterm=italic
    hi rstStandaloneHyperlink guifg=#a3be8c guibg=NONE guisp=NONE gui=underline cterm=underline
    ...
    hi htmlH4 guifg=#a3be8c guibg=NONE guisp=NONE gui=bold cterm=bold
    hi htmlH5 guifg=#7cbcbb guibg=NONE guisp=NONE gui=bold cterm=bold
    hi htmlH6 guifg=#94b7f0 guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    hi helpURL guifg=#7cbcbb guibg=NONE guisp=NONE gui=underline cterm=underline
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi Blue ctermfg=111 ctermbg=NONE cterm=NONE
    ...
    hi MoreMsg ctermfg=111 ctermbg=NONE cterm=bold
    ...
    if get(g:, 'edge_popup_menu_selection_background', 'blue') ==# 'blue'
      hi PmenuSel ctermfg=235 ctermbg=111 cterm=NONE
      hi WildMenu ctermfg=235 ctermbg=111 cterm=NONE
    elseif get(g:, 'edge_popup_menu_selection_background', 'green') ==# 'green'
    ...
    hi SpellLocal ctermfg=111 ctermbg=NONE cterm=NONE
    hi SpellRare ctermfg=176 ctermbg=NONE cterm=NONE
    hi StatusLine ctermfg=251 ctermbg=239 cterm=NONE
    hi StatusLineTerm ctermfg=251 ctermbg=239 cterm=NONE
    ...
    hi QuickFixLine ctermfg=111 ctermbg=236 cterm=NONE
    ...
    hi SpecialKey ctermfg=111 ctermbg=NONE cterm=NONE
    ...
    if get(g:, 'edge_transparent_background', 0)
      ...
      hi GitGutterChange ctermfg=111 ctermbg=NONE cterm=NONE
    ...
    hi CtrlPMode1 ctermfg=111 ctermbg=236 cterm=bold
    hi CtrlPMode2 ctermfg=236 ctermbg=111 cterm=bold
    ...
    hi Lf_hl_match2 ctermfg=111 ctermbg=NONE cterm=bold
    ...
    elseif get(g:, 'edge_current_word', get(g:, 'edge_transparent_background', 0) == 0 ? 'grey background' : 'bold') ==# 'grey background'
      hi CocHighlightText ctermfg=NONE ctermbg=238 cterm=NONE
    endif
    ...
    hi QuickScopeSecondary ctermfg=111 ctermbg=NONE cterm=underline
    ...
    hi markdownH6 ctermfg=111 ctermbg=NONE cterm=bold
    ...
    hi htmlH6 ctermfg=111 ctermbg=NONE cterm=bold
...
" Background: dark
" Color: background    #252931           ~                 Black
" Color: foreground    #bcc4d1           ~                 White          # 76.506
" Color: red           #ef7f7f           ~                 Red            # 62.934
" Color: yellow        #d2b57b           ~                 Yellow         # 71.787
" Color: green         #a3be8c           ~                 Green          # 69.109
" Color: cyan          #7cbcbb           ~                 Cyan           # 64.188
" Color: blue          #94b7f0           ~                 Blue           # 70.647
" Color: purple        #d898eb           ~                 Magenta        # 70.822
" Color: grey          #88909f           ~                 Grey
" Color: background_line #2c313b         ~                 LightGrey
" Color: background_col #2e3440          ~                 LightGrey
" Color: background_pmenu #393f4e        ~                 LightGrey
" Color: background_sign #434c5e         ~                 LightGrey
" Color: background_visual #3b4252       ~                 LightGrey
...
" Color: background_green_sel #a3be8c    ~                 LightGreen
" Color: background_blue_sel #94b7f0     ~                 LightBlue
